...
%%%%% Education %%%%%
\mhead{Education}%
\pyc{import cv; cv.get_education()}
\bigskip

%%%%% Experience %%%%%
\mhead{Experience}%
\pyc{import cv; cv.get_experience()}
\bigskip
...
\begin{multicols}{3}
\pyc{import cv; print(cv.get_skills())}
\end{multicols}
\bigskip
...
%%%%% Languages %%%%%
\mhead{Languages}
\pyc{import cv; print(cv.get_languages())}
\bigskip
...
%%%%% Interests %%%%%
\mhead{Interests}
\pyc{import cv; print(cv.get_interests())}
\end{document}
