...
\begin{itemize}
  ...
  \item Implemented an algorithm to determine relevant webpages based on browsing history
\end{itemize}
\bigskip
...
Created a web crawler to scrape and publish a feed of the UCSC Engineering events page
\medskip
...
Published an app to the Google Play store that uses multiple sensors to detect free fall
\medskip

\begin{comment}
\textbf{ChordLookup} \rdate{\textsc{march}~2015}\\
\emph{Web Service} \hfill \suplinks{\href{https://github.com/benjaminran/chordlookup}{Source}}\\
Created a Spotify app to retrieve the chords to each new track played in Spotify
\bigskip
\end{comment}
...
%%%%% Languages %%%%%
\mhead{Languages}
Java, Python, \CPP{}, Javascript, Bash
\medskip
