...
\begin{itemize*}
  ...
  \item Configured and worked with CDH and HDP Hadoop distributions using Kerberos authentication as well as Apache Sentry 
    and Ranger authorization to ensure proper function of the Waterline Data Inventory in its interactions with HDFS and Hive
\end{itemize*}
\medskip
\textbf{HackingEDU Hackathon}, San Mateo, CA \newline
\emph{Participant} \rdate{\textsc{october}~2015}
\begin{itemize}
