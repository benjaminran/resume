...
if __name__=="__main__":
    ...
    parser.add_argument('-t', '--template_dir', help='path to templates directory', default='/resume/templates')
    parser.add_argument('-o', '--output_dir', help='path to output file', default='/resume/output')
    parser.add_argument('-c', '--content', help='path to cv.xml', default='/resume/content/cv.xml')
    args = parser.parse_args()
    for template in os.listdir(args.template_dir):
        build(os.path.abspath(os.path.join(args.output_dir, re.sub('\.jinja$', '', template))), os.path.abspath(os.path.join(args.template_dir, template)), os.path.abspath(args.content))
